package id.ac.poliban.mi.maya.latihan10;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPhone.setOnClickListener(v -> {
            Uri uri = Uri.parse("tel:082253352984");
        ...
        btEmail.setOnClickListener(v -> {
            Uri uri = Uri.parse("mailto:mayadiahatikasari@gmail.com");
            Intent intent = new Intent();
            intent.setAction(Intent.ACTION_VIEW);
            intent.setData(uri);
            startActivity(intent);
        ...
        btWebsite.setOnClickListener(v ->
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/mayadiahatikasari"))));
